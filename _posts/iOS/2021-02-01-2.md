...
**💡 Notice :**
답을 정리한 글은 체크가 되어있으며, 클릭 시 정리한 글로 이동한다. 
{: .notice--info}
...
- [x] [Optional 이란 무엇인지 설명하시오.](https://sanghyuk.dev/swift-grammar/6-1/)
...
- [ ] [함수형 프로그래밍이 무엇인지 설명하시오.(작성중)](https://sanghyuk.dev/swift-grammar/7-1/)
- [ ] 고차 함수가 무엇인지 설명하시오.
...
출처 : [이재성님의 깃허브](https://github.com/JeaSungLEE/iOSInterviewquestions)
