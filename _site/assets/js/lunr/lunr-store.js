var store = [{
        ...
        "tags": ["Swift","Swift-Grammar","꼼곰한 재은 씨의 스위프트:문법편","이재은","루비페이퍼","ISBN:979-11-86710-23-4","Swift","스위프트","iOS"],
        "url": "https://sanghyuk.dev/swift-grammar/1-1/",
        ...
        "tags": ["Swift","Swift-Grammar","꼼곰한 재은 씨의 스위프트:문법편","이재은","루비페이퍼","ISBN:979-11-86710-23-4","Swift","스위프트","iOS"],
        "url": "https://sanghyuk.dev/swift-grammar/1-2/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/Swift-Grammar/swift.png"
      },{
        ...
        "tags": ["Swift","Swift-Grammar","꼼곰한 재은 씨의 스위프트:문법편","이재은","루비페이퍼","ISBN:979-11-86710-23-4","Objective-C","Swift","스위프트","오브젝티브-C","iOS"],
        "url": "https://sanghyuk.dev/swift-grammar/1-3/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/Swift-Grammar/swift.png"
      },{
        "title": "CHAPTER02: Xcode - 1. 통합개발 환경",
        "excerpt":"이번에 다룰 내용은 툴(Tool)이다. 프로그래밍 환경에서 툴이 차지하는 비중은 상당하다. 얼마나 빠르고 쉽게 개발할 수 있는지가 툴에 달려 있기 때문이다. 그래서 툴에 대해 자세히 알고, 마음대로 다룰 수 있도록 능력을 갖추는 것은 매우 중요하다. 현대 프로그래밍은 상당히 많은 부분을 툴에 의존하는 경향이 있지만, 이는 툴과 프로그래밍 개발이 이제 떼려야 뗄...","categories": ["Swift-Grammar"],
        "tags": ["Swift","Swift-Grammar","꼼곰한 재은 씨의 스위프트:문법편","이재은","루비페이퍼","ISBN:979-11-86710-23-4","Xcode","엑스코드","IDE"],
        "url": "https://sanghyuk.dev/swift-grammar/2-1/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/Swift-Grammar/swift.png"
      },{
        ...
        "tags": ["Swift","Swift-Grammar","꼼곰한 재은 씨의 스위프트:문법편","이재은","루비페이퍼","ISBN:979-11-86710-23-4","Xcode","엑스코드"],
        "url": "https://sanghyuk.dev/swift-grammar/2-2/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/Swift-Grammar/swift.png"
      },{
        ...
        "tags": ["Swift","Swift-Grammar","꼼곰한 재은 씨의 스위프트:문법편","이재은","루비페이퍼","ISBN:979-11-86710-23-4","Xcode","엑스코드"],
        "url": "https://sanghyuk.dev/swift-grammar/2-3/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/Swift-Grammar/swift.png"
      },{
        ...
        "tags": ["Swift","Swift-Grammar","꼼곰한 재은 씨의 스위프트:문법편","이재은","루비페이퍼","ISBN:979-11-86710-23-4","Xcode","엑스코드"],
        "url": "https://sanghyuk.dev/swift-grammar/2-4/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/Swift-Grammar/swift.png"
      },{
        ...
        "url": "https://sanghyuk.dev/swift-grammar/2-5/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/Swift-Grammar/swift.png"
      },{
        ...
        "excerpt":"옵셔널(Optional)은 스위프트에서 도입된 새로운 개념으로서 언어 차원에서 프로그램의 안정성을 높이기 위해 사용하는 개념이다. 옵셔널의 개념을 한 문장으로 정의하자면 ‘nil을 사용할 수 있는 타입과 사용할 수 없는 타입을 구분하고, 사용할 수 있는 타입을 가리켜 옵셔널 타입(Optional Type)이라고 부른다’라고 할 수 있다. 여기서 말하는 nil이란, 값이 없음을 의미하는 특수한 값이다. 정수형의 0이나,...","categories": ["Swift-Grammar"],
        "tags": ["Swift","Swift-Grammar","꼼곰한 재은 씨의 스위프트:문법편","이재은","루비페이퍼","ISBN:979-11-86710-23-4","옵셔널"],
        "url": "https://sanghyuk.dev/swift-grammar/6-1/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/Swift-Grammar/swift.png"
      },{
        "title": "CHAPTER06: 옵셔널 - 2. 옵셔널 값 처리",
        "excerpt":"2. 옵셔널 값 처리 문자열을 숫자로 변환해주는 생성자 Int(문자열) 이야기를 조금 더 해보자. 숫자로 바꿀 수 있는 문자열 \"123\"이 입력되면 숫자로 변환할 수 있지만, 그럴 수 없는 일반 문자열이 입력되면 잠재적인 오류 가능성이 있다고 설명했다. 이 때문에 Int(문자열)은 그냥 정수가 아니라 옵셔널 타입의 정수값을 반환하도록 설계되어 있다. Int 구조체의 생성자를...","categories": ["Swift-Grammar"],
        "tags": ["Swift","Swift-Grammar","꼼곰한 재은 씨의 스위프트:문법편","이재은","루비페이퍼","ISBN:979-11-86710-23-4","옵셔널","Optional","언래핑","unwrapping"],
        "url": "https://sanghyuk.dev/swift-grammar/6-2/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/Swift-Grammar/swift.png"
      },{
        "title": "CHAPTER07: 함수 - 1.함수의 기본 개념",
        "excerpt":"함수(Function)는 대부분의 프로그래밍 언어에서 지원하는 개념으로 프로그램의 실행 과정 중에서 독립적으로 처리될 수 있는 부분을 분리하여 구조화한 객체를 의미한다. 즉, 외부에 의존하는 부분 없이 툭 떼어 분리할 수 있는 실행 단위를 일종의 캡슐처럼 포장해놓은 것이다. 이렇게 독립적으로 작성된 함수는 간단한 방식으로 여러 번 호출하여 사용할 수 있어서 같은 코드를 반복해서...","categories": ["Swift-Grammar"],
        "tags": ["Swift","Swift-Grammar","꼼곰한 재은 씨의 스위프트:문법편","이재은","루비페이퍼","ISBN:979-11-86710-23-4","함수","문법"],
        "url": "https://sanghyuk.dev/swift-grammar/7-1/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/Swift-Grammar/swift.png"
      },{
        "title": "기획",
        ...
        "url": "https://sanghyuk.dev/product-manager/1/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/ProductManager/ProductManager.png"
      },{
        "title": "[CHAPTER 1] 훌륭한 제품을 이끄는 사람",
        "excerpt":"Part.1 최고의 기술 기업에서 배운 것 제품을 만드는 사람들이 밤과 주말을 희생해 가며 오랜 기간 열심히 제품을 만들었다. 제품을 설명하는 자리를 가졌고 좋은 평가를 받았다. 성공을 위한 만반의 준비를 하고 마침내 제품을 출시했다. 그런데 제품은 실패했다. 원인은 제품을 구매하는 사람이 없었기 때문이다. 기술적으로 매우 훌륭한 제품이었고, 전문가들은 극찬을 아끼지 않았다....","categories": ["Product-Manager"],
        "tags": ["Product-Manager","Product","Manager","PM"],
        "url": "https://sanghyuk.dev/product-manager/2/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/ProductManager/ProductManager.png"
      },{
        "title": "[CHAPTER 2] 기술 중심의 제품과 서비스",
        "excerpt":"기술 중심의 제품과 서비스 소비재 제품과 같은 비기술(non-tech) 제품 및 해당 제품의 관리자들을 위한 좋은 자료들은 이미 쉽게 구할 수 있을 정도로 충분하다. 여기서는 내가 현제 일하고 있는 분야인 오로지 기술 중심의 제품에만 집중한다. 기술 중심의 제품, 서비스, 사용자 경험을 만드는 것과 관련된 고유의 이슈와 도전들을 다룬다. 소비자 서비스 제품들이...","categories": ["Product-Manager"],
        "tags": ["Product-Manager","Product","Manager","PM"],
        "url": "https://sanghyuk.dev/product-manager/3/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/ProductManager/ProductManager.png"
      },{
        "title": "[CHAPTER 3] 스타트업: 제품/시장 궁합 찾기",
        "excerpt":"스타트업: 제품/시장 궁합 찾기 기술 산업에서 일반적으로 회사를 스타트업(startup), 성장 단계(growth-stage)의 기업, 대기업(enterprise companies)의 세 가지 단계로 정의한다. 스타트업은 ‘제품/시장 궁함(product/market fit)을 아직 찾지 못한, 새로운 제품을 만드는 회사’ 라고 간단히 정의할 수 있다. 제품/시장 궁합은 너무나도 중요한 개념이며, 다시 자세히 알아보자. 스타트업이란, ‘유효한 비즈니스를 창출하는 제품을 찾기 위해 여전히...","categories": ["Product-Manager"],
        "tags": ["Product-Manager","Product","Manager","PM"],
        "url": "https://sanghyuk.dev/product-manager/4/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/ProductManager/ProductManager.png"
      },{
        "title": "[CHAPTER 4] 성장 단계의 회사: 성공을 위한 확장",
        "excerpt":"성장 단계의 회사: 성공을 위한 확장 충분한 역량과 운을 바탕으로 마침내 제품/시장 궁합을 달성한 스타트업들은 지금까지만큼이나 어려운 도전 상황을 이겨 낼 준비를 해야 한다. 어떻게 효과적으로 성장하고 확장해 나갈 것인가 하는 문제다. 스타트업이 큰 규모의 성공적인 비즈니스로 성장하고 확장하는 과정에는 여러 중대한 도전들이 있다. 엄청나게 어려운 도전이긴 하지만, 이른바 행복한...","categories": ["Product-Manager"],
        "tags": ["Product-Manager","Product","Manager","PM"],
        "url": "https://sanghyuk.dev/product-manager/5/",
        "teaser": "https://sanghyuk.dev/assets/images/posts/ProductManager/ProductManager.png"
      },{
        "title": "최고 제품 책임자(CPO)",
